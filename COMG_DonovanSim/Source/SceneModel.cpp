...
void SceneModel::Init()
{
    ...
    //meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJ("model1", "OBJ//V_Art Land.obj");
    //meshList[GEO_MODEL1]->textureID = LoadTGA("Image//outUV.tga");
...
void SceneModel::RenderMesh(Mesh *mesh, bool enableLight, bool toggleLight)
{
...
void SceneModel::Render()
{
    ...
    RenderMesh(meshList[GEO_MODEL1], true, toggleLight);
    modelStack.PopMatrix();
